...
export const SchoolBlock = ({
  ...
  return <Card className="group p-8 hover-lift animate-slide-up border-2 border-border hover:border-foreground/20 transition-all duration-500 relative overflow-hidden" style={{
    animationDelay: `${delay}ms`
      ...
      <div className="flex flex-col items-center text-center gap-6 relative z-10">
        <div className="w-20 h-20 rounded-2xl bg-foreground/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 group-hover:bg-foreground/20">
          <Building2 className="w-10 h-10 transition-all duration-500 group-hover:scale-110 text-zinc-500" />
        </div>
